...
export const getAlarmSql='select DISTINCT alarm.id,is_confirm,alarm.created_at,alarm.updated_at,type,content,state,alarm.user_id,video_id,video.title from alarm left outer join video on video.id=alarm.video_id where alarm.user_id=15 order by alarm.created_at DESC;';
